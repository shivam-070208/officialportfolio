...
const About = () => {
  return (
    <section id="about" className="w-screen min-h-screen flex flex-col md:flex-row items-center justify-center bg-black text-white  md:mt-0 mt-10 md:pr-30 px-6 md:px-0 py-16">
